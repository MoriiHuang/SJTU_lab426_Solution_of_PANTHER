...
│   ├── ...
"""
# base = '/home/SSD-2T-2023/hcy/nnUNet_new/DATASET'
...
# nnUNet_preprocessed = join(base, 'Umamba_preprocessed') # os.environ.get('nnUNet_preprocessed')
# nnUNet_results = join(base, 'Umamba_results') # os.environ.get('nnUNet_results')
